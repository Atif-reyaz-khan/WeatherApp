...
public class FakeDataUtils {
    ...
    private static ContentValues createTestWeatherContentValues(long date) {
        ...
        testWeatherValues.put( WeatherContact.WeatherEntry.COLUMN_DATE, date);
        testWeatherValues.put( WeatherContact.WeatherEntry.COLUMN_DEGREES, Math.random()*2);
        testWeatherValues.put( WeatherContact.WeatherEntry.COLUMN_HUMIDITY, Math.random()*100);
        testWeatherValues.put( WeatherContact.WeatherEntry.COLUMN_PRESSURE, 870 + Math.random()*100);
        int maxTemp = (int)(Math.random()*100);
        testWeatherValues.put( WeatherContact.WeatherEntry.COLUMN_MAX_TEMP, maxTemp);
        testWeatherValues.put( WeatherContact.WeatherEntry.COLUMN_MIN_TEMP, maxTemp - (int) (Math.random()*10));
        testWeatherValues.put( WeatherContact.WeatherEntry.COLUMN_WIND_SPEED, Math.random()*10);
        testWeatherValues.put( WeatherContact.WeatherEntry.COLUMN_WEATHER_ID, weatherIDs[(int)(Math.random()*10)%5]);
    ...
    public static void insertFakeData(Context context) {
        ...
        context.getContentResolver().bulkInsert(
                WeatherContact.WeatherEntry.CONTENT_URI,
