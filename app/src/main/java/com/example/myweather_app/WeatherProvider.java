...
public class WeatherProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        final String authority = WeatherContact.CONTENT_AUTHORITY;
        ...
        matcher.addURI(authority, WeatherContact.PATH_WEATHER, CODE_WEATHER);
         ...
         */
        matcher.addURI(authority, WeatherContact.PATH_WEATHER + "/#", CODE_WEATHER_WITH_DATE);
            ...
            case CODE_WEATHER:
                ...
                try {
                    for (ContentValues value : values) {
                        long weatherDate =
                                value.getAsLong(WeatherContact.WeatherEntry.COLUMN_DATE);
                        if (!SunshineDateUtils.isDateNormalized(weatherDate)) {
                            throw new IllegalArgumentException("Date must be normalized to insert");
                        }

                        long _id = db.insert(WeatherContact.WeatherEntry.TABLE_NAME, null, value);
                        if (_id != -1) {
                            rowsInserted++;
                        }
                    }
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case CODE_WEATHER_WITH_DATE: {
                ...
                cursor = mOpenHelper.getReadableDatabase().query(
                        ...
                        WeatherContact.WeatherEntry.TABLE_NAME,
                        /*
