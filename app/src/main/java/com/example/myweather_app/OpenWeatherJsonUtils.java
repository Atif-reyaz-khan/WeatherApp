...
//        long normalizedUtcStartDay = SunshineDateUtils.normalizeDate(now);
        ...
        for (int i = 0; i < jsonWeatherArray.length(); i++) {
            ...
            weatherValues.put(WeatherContact.WeatherEntry.COLUMN_DATE, dateTimeMillis);
            weatherValues.put(WeatherContact.WeatherEntry.COLUMN_HUMIDITY, humidity);
            weatherValues.put(WeatherContact.WeatherEntry.COLUMN_PRESSURE, pressure);
            weatherValues.put(WeatherContact.WeatherEntry.COLUMN_WIND_SPEED, windSpeed);
            weatherValues.put(WeatherContact.WeatherEntry.COLUMN_DEGREES, windDirection);
            weatherValues.put(WeatherContact.WeatherEntry.COLUMN_MAX_TEMP, high);
            weatherValues.put(WeatherContact.WeatherEntry.COLUMN_MIN_TEMP, low);
            weatherValues.put(WeatherContact.WeatherEntry.COLUMN_WEATHER_ID, weatherId);
