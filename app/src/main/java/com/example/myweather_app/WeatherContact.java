...
import com.example.myweather_app.SunshineDateUtils;

public class WeatherContact {
    public static final String CONTENT_AUTHORITY = "com.example.myweather_app";
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static String getSqlSelectForTodayOnwards() {
            ...
            return WeatherContact.WeatherEntry.COLUMN_DATE + " >= " + normalizedUtcNow;
        }
    }
